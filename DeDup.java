...
public class DeDup {
     ...
     *
     * @param ints the array of random, unordered integers (may contain duplicates)
     * @param set the set of Integers containing unique integers
	 * @return array of unique integers based on superset of ints
	 * 
	 * @TestCase
     */
     ...
     *
     * @param ints the array of random, unordered integers (may contain duplicates)
     * @param hash a HashMap of Integer, String whose keys will be populated with the values of ints
     ...
     *
     * @param ints the array of random, unordered integers (may contain duplicates)
     * @param arraList an ArrayList that will be populated with the value of ints, retaining the original order of ints, but containing no dups
     ...
     *
     * @param elements Collection of Integers to be converted to int[]
	 * @return array of unique integers based on superset of ints
	 * 
	 * @TestCase
     */
